<?php
    ...
    $result_check = mysqli_query($con, $checkquery); //Running $checkquery
    ...
    } elseif (strlen($username) > 15){//Checks if username entered is longer than 15 characters
        $output_message = "Username is too long";
        echo $output_message;
    }else{
        $result_query = mysqli_query($con,$insertquery);//Run query if all else is fine.
